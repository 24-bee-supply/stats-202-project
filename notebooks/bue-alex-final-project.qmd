...
4. I also use gradient boosting with XGBoost. The tuning parameters are below:
...
```
Computational constraints limit somewhat my range of tuning parameters. I do not tune probability thresholds, though this would be an obvious next step in my analysis. Boosting could be tuned with more options, not just the number of rounds. 
